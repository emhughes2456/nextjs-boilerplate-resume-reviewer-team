...
export default async function ProfilePage() {
  ...
  const categoryColors: Record<string, string> = {
    ...
    Tool: "bg-purple-50 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300",
    Soft: "bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300",
    Domain: "bg-orange-50 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300",
  ...
  return (
    <div className="max-w-2xl">
      ...
      {/* User Card */}
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 mb-5">
