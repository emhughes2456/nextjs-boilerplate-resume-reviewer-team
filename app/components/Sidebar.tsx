...
export default function Sidebar() {
  ...
  return (
    <aside className="w-56 min-h-screen bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col shrink-0">
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100 dark:border-gray-700">
        ...
        <div>
          <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 leading-tight">AI Resume</p>
          <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 leading-tight">Reviewer</p>
